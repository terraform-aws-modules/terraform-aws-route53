...
| <a name="provider_aws.external"></a> [aws.external](#provider\_aws.external) | >= 6.25 |
| <a name="provider_aws.external_region"></a> [aws.external\_region](#provider\_aws.external\_region) | >= 6.25 |
